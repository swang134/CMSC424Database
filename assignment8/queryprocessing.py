...
# You have to implement the Set EXCEPT operator 
# The input is two relations with identical schema, and the output is: left_child EXCEPT right_child
...
class SetExcept(Operator):
	...
	def get_next(self):
		if len(self.left_child.relation.schema) != len(self.right_child.relation.schema):
			return
