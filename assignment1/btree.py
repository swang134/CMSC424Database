...
class BTreeDisplayRectangle:
    ...
    def getKthPointer(self, k):
        ...
        #print("======")
        #print(index)
        #print(self.btreenode.keysAndPointers)
        #print("======")
        return (self.corner_x + (WIDTH_PER_KEY + WIDTH_PER_POINTER) * k + WIDTH_PER_POINTER/2, self.corner_y + self.height*0.9, self.btreenode.keysAndPointers[index])
