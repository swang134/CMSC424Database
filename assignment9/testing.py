...
def deadlockSituation():
	...
	t.start()
def woundWaitSituation():
	t = threading.Thread(target=Transaction3, args=(r, "0", "10"))
	t.start()
	t1 = threading.Thread(target=Transaction7, args=(r, "10", "0"))
	t = threading.Thread(target=Transaction3, args=(r, "20", "10"))
	t2 = threading.Thread(target=Transaction7, args=(r, "10", "20"))
	t2.start()
	t.start()
	t1.start()
